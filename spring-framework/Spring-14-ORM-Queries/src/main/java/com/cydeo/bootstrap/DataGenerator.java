...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("find by country" + regionRepository.findDistinctByCountry("Canada"));
        System.out.println("find by country" + regionRepository.findByCountryContaining("United"));
        System.out.println("find by country" + regionRepository.findByCountryContainingOrderByCountry("United"));
        System.out.println("find by country" + regionRepository.findTop2ByCountry("Canada"));
